...
/**
 * Tests for {@link CalabashPipelineFactory}.
 * 
 * @author Herve Quiroz
 */
public final class CalabashPipelineFactoryTest
{
    @Test
    public void newInstance()
    {
        final PipelineFactory factory = PipelineFactory.newInstance();
        Assert.assertEquals(factory.getClass(), CalabashPipelineFactory.class);
    }
}
